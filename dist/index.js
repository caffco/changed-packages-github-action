...
function getChangedPackagesWithoutReleasePlan({ repositoryRootPath, repositoryBaseBranch }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const packagesWithReleasePlan = yield getPackagesWithReleasePlan({
            repositoryRootPath,
            repositoryBaseBranch
        });
        const packagesWithReleasePlanNames = packagesWithReleasePlan.map(singlePackage => singlePackage.packageJson.name);
        const changedPackagesWithoutReleasePlan = changedPackages.filter(singlePackage => !packagesWithReleasePlanNames.includes(singlePackage.packageJson.name));
...
exports.getChangesetVersionByPackageName = getChangesetVersionByPackageName;
